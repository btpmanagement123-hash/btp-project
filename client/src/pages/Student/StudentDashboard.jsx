  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        console.log("Student BTP:", cRes.data);
  ...
  return (
    <div style={styles.container}>
      ...
      <p style={styles.smallMuted}>
        Stay updated with your project and system alerts.
      </p>
      ...
      <p style={styles.smallMuted}>
        Overview of current project configurations.
      </p>
      ...
      <div style={styles.summaryGrid}>
        ...
        <div style={styles.summaryCard}>
          <p style={styles.sectionTitle}>Timeline</p>
