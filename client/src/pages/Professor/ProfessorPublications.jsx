...
const ProfessorPublications = () => {
  ...
  return (
    <div style={styles.wrapper}>
      ...
      {/* FORM */}
      <form onSubmit={handleAdd} style={styles.form}>
        <Input name="doi" placeholder="DOI *" form={form} handleChange={handleChange} required />
        <Input name="title" placeholder="Title *" form={form} handleChange={handleChange} required />
        <Input name="journal" placeholder="Journal / Conference" form={form} handleChange={handleChange} />
        <Input name="year" placeholder="Year" form={form} handleChange={handleChange} />
        <Input name="authors" placeholder="Authors" form={form} handleChange={handleChange} />
        <Input name="link" placeholder="Link" form={form} handleChange={handleChange} />
...
/* Reusable Input */
const Input = ({ name, placeholder, form, handleChange, required }) => (
  <input
    name={name}
