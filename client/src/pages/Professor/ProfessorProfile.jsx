...
const ProfessorProfile = () => {
  ...
  const handlePhotoChange = async (e) => {
    ...
    try {
      ...
      const uRes = await api.post("/professor/profile/photo", {
        photoUrl: url
      });
    ...
    <div style={styles.wrapper}>
      ...
      <div style={styles.topGrid}>
        ...
        <div style={styles.leftCard}>
          ...
          <div style={styles.textCenterMobile}>
            <h3 style={styles.name}>{profile.name}</h3>
            <p style={styles.sub}>{profile.designation}</p>
            <p style={styles.sub}>{profile.department}</p>
          </div>
        </div>
      ...
      <div style={styles.fullCard}>
        ...
        <InfoRow
          label="Employee ID"
          value={profile.staffId || profile.userId}
        />
